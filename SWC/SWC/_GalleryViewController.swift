...
//  SWC
//
//  Created by Leandro Fonseca on 18/01/18.
...
class GalleryViewController: UIViewController {
    ...
    override func loadView() {
        ...
        remoteGalleryButton.addTarget(self, action: #selector(GalleryViewController.showOnlineGallery(_:)), for: .touchUpInside)
        ...
        localGalleryButton.addTarget(self, action: #selector(GalleryViewController.showLocalGallery(_:)), for: .touchUpInside)
